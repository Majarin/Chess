...
//C Light
{
    ...
    if (L1 == false)
    {
        ...
        if (KingLSqare.hasChildNodes() == true)
        {
            if (KingLSqare.firstElementChild.classList.contains("Pawn") && KingLSqare.firstElementChild.classList.contains("D"))
            {                   
                checkL[numL] = String.fromCharCode(96 + LX) + LY
                numL++
            }
    ...
    if (L1 == false)
    {
        KingLSqare = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare.hasChildNodes() == true)
        {
            if (KingLSqare.firstElementChild.classList.contains("Pawn") && KingLSqare.firstElementChild.classList.contains("D"))
            {                   
    ...
    {
        KingLSqare2 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare2.hasChildNodes() == true)
            {
                if (KingLSqare2.firstElementChild.classList.contains("Knight") && KingLSqare2.firstElementChild.classList.contains("D"))
                {
                    checkL[numL] = String.fromCharCode(96 + LX) + LY
                    numL++
                } 
    ...
    {
        KingLSqare3 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare3.hasChildNodes() == true)
            {
                if (KingLSqare3.firstElementChild.classList.contains("Knight") && KingLSqare3.firstElementChild.classList.contains("D"))
                {
                    checkL[numL] = String.fromCharCode(96 + LX) + LY
                    numL++
                } 
    ...
    {
        KingLSqare4 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare4.hasChildNodes() == true)
            {
                if (KingLSqare4.firstElementChild.classList.contains("Knight") && KingLSqare4.firstElementChild.classList.contains("D"))
                {
                    checkL[numL] = String.fromCharCode(96 + LX) + LY
                    numL++
                } 
    ...
    {
        KingLSqare5 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare5.hasChildNodes() == true)
            {
                if (KingLSqare5.firstElementChild.classList.contains("Knight") && KingLSqare5.firstElementChild.classList.contains("D"))
                {
                    checkL[numL] = String.fromCharCode(96 + LX) + LY
                    numL++
                } 
    ...
    {
        KingLSqare6 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare6.hasChildNodes() == true)
            {
                if (KingLSqare6.firstElementChild.classList.contains("Knight") && KingLSqare6.firstElementChild.classList.contains("D"))
                {
                    checkL[numL] = String.fromCharCode(96 + LX) + LY
                    numL++
                } 
    ...
    {
        KingLSqare7 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare7.hasChildNodes() == true)
            {
                if (KingLSqare7.firstElementChild.classList.contains("Knight") && KingLSqare7.firstElementChild.classList.contains("D"))
                {
                    checkL[numL] = String.fromCharCode(96 + LX) + LY
                    numL++
                } 
    ...
    {
        KingLSqare8 = document.getElementById(String.fromCharCode(96 + LX) + LY)
        if (KingLSqare8.hasChildNodes() == true)
        {
            if (KingLSqare8.firstElementChild.classList.contains("Knight") && KingLSqare8.firstElementChild.classList.contains("D"))
            {
                checkL[numL] = String.fromCharCode(96 + LX) + LY
                numL++
            } 
...
//MARK:_________________________________________________________________________________________
    const KnightLog= 
    [
        [1, 2],
        [2, 1],
